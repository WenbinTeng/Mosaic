...
#pragma HLS INTERFACE m_axi port=res offset=slave bundle=data
    ...
    hls_thread_local hls::task t1(top_in, img, in_stream);
    hls_thread_local hls::task t2(conv1, in_stream, conv1_out_stream);
    hls_thread_local hls::task t3(pool1, conv1_out_stream, pool1_out_stream);
    hls_thread_local hls::task t4(conv2, pool1_out_stream, conv2_out_stream);
    hls_thread_local hls::task t5(pool2, conv2_out_stream, pool2_out_stream);
    hls_thread_local hls::task t6(fc1, pool2_out_stream, fc1_out_stream);
    hls_thread_local hls::task t7(fc2, fc1_out_stream, fc2_out_stream);
    hls_thread_local hls::task t8(fc3, fc2_out_stream, fc3_out_stream);
    hls_thread_local hls::task t9(top_out, fc3_out_stream, res);
}